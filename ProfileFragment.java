...
private EditText editTextName, editTextEmployeeId, editTextBranch,
editTextPost, editTextEmail, editTextPhone, editTextAge,
editTextAddress; private Button buttonSaveProfile,
buttonUpdateProfile; private MongoClient mongoClient; private
MongoDatabase mongoDatabase;
private MongoCollection<Document> profileCollection;
@Nullable
public View onCreateView(@NonNull LayoutInflater inflater, @Nullable
ViewGroup container, @Nullable Bundle savedInstanceState) {
View view = inflater.inflate(R.layout.fragment_profile, container, false); // Initialize
UI components editTextName = view.findViewById(R.id.editTextName);
editTextEmployeeId = view.findViewById(R.id.editTextEmployeeId); editTextBranch
= view.findViewById(R.id.editTextBranch); editTextPost =
view.findViewById(R.id.editTextPost); editTextEmail =
...
view.findViewById(R.id.buttonSaveProfile); buttonUpdateProfile =
view.findViewById(R.id.buttonUpdateProfile);
initializeMongoDB();
